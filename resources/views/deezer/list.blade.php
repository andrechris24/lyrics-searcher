					...
					<div class="card-footer">
						<div class="btn-group" role="group">
							<button type="button" class="btn btn-primary" data-coreui-toggle="modal"
								...
								data-coreui-track="{{ $result['title'] }}"
							...
							<button type="button" class="btn btn-secondary download-btn"
								...
								data-artist="{{ $result['artist']['name'] }}" data-coreui-toggle="tooltip"
								data-coreui-title="Download song">
							...
							<a href="{{ $result['link'] }}" @class(['btn', 'btn-success', 'disabled' => empty($result['link'])])
								...
								data-coreui-title="Go to Deezer" target="_blank">
