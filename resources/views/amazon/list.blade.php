					...
					<div class="card-footer">
						<div class="btn-group" role="group">
							<button class="btn btn-primary" data-coreui-id="{{ $result['track_id'] }}"
								data-coreui-artist="{{ $result['artist'] }}"
							...
							<a href="{{ $result['deeplink'] }}" @class([
								'btn',
								'btn-success',
								'disabled' => empty($result['deeplink'])
							])
								aria-disabled="{{ empty($result['deeplink']) }}" data-coreui-toggle="tooltip"
								data-coreui-title="Go to Amazon Music" target="_blank">
