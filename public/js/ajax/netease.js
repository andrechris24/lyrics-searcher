/* global blobDL, toast, zpad, basicForm */
...
$(basicForm).submit(function (event) {
	...
	$("#netease-container").html("");
	$("#netease-loader").removeClass("d-none");
...
function sendAjax(data) {
	...
	$.ajax({
		...
		.always(function () {
			...
			$("#netease-container").LoadingOverlay("hide");
			$("#netease-loader").addClass("d-none");
		});
}
